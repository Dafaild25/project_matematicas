...
from ...decorators import estudiante_required # Importar decorador de permisos
...
def editar_perfil_estudiante(request):
    ...
    estudiante = get_object_or_404(Estudiantes, fk_id_persona__fk_id_usuario=request.user)
    ...
    return render(request, 'masterestudiante/perfil/Edit.html', contexto)
    ...
    if request.method == 'POST':
       ...
       # Validar formularios completos
        if not formUsuario.is_valid() or not formPersona.is_valid():
            ...
            return render(request, 'masterestudiante/perfil/Edit.html', {
                'formUsuario': formUsuario,
                'formPersona': formPersona,
                'estudiante': estudiante,
                'persona': persona,
        ...
        try:
            ...
            return redirect('core_estudiante')
